...
class PersonCustom(SQLModel, table=True):
    __tablename__: str = "persons_custom"

    __table_args__ = (
        UniqueConstraint("person_custom_uuid", name="person_custom_uuid_unique"),
    )
    ...
    person_custom_uuid: Optional[str] = Field(
        nullable=True, sa_column=Column(String(64)), default=None
    )
