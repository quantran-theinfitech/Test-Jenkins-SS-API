...
class SalesforceCompanyPullHistories(SQLModel, table=True):
    __tablename__: str = "salesforce_company_pull_histories"
    __table_args__ = (Index("idx_salesforce_company_pull_histories_id", "id"),)
