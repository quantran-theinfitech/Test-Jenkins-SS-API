...
class HubspotPullPersonHistories(SQLModel, table=True):
    __tablename__: str = "hubspot_pull_person_histories"
    __table_args__ = (Index("idx_hubspot_pull_person_histories_id", "id"),)
