...
class HubspotCompanyPullHistories(SQLModel, table=True):
    __tablename__: str = "hubspot_company_pull_histories"
    __table_args__ = (Index("idx_hubspot_company_pull_histories_id", "id"),)
