...
class Company(SQLModel, table=True):
    ...
    __table_args__ = (
        UniqueConstraint("corporate_number", name="companies_corporate_number_unique"),
    )
    ...
    # latest_middle_recruit_at: Optional[int] = Field(
    #     nullable=True, sa_column=Column(BigInteger), default=None
    # )
    # latest_parttime_recruit_at: Optional[int] = Field(
    #     nullable=True, sa_column=Column(BigInteger), default=None
    # )
    ...
    phone_verify: Optional[str] = Field(
        nullable=True, sa_column=Column(Text), default=None
    )
    phone_verify_method_quality: Optional[int] = Field(
        nullable=True, sa_column=Column(Integer), default=None
    )
