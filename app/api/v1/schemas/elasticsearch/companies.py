...
class EsCompany(Document):
    ...
    business_content = Text(search_analyzer="jp_analyzer")
    ...
    created_at = Date()
    updated_at = Date()
    meta_title = Text(search_analyzer="jp_analyzer")
    meta_description = Text(search_analyzer="jp_analyzer")
    meta_keywords = Text(search_analyzer="jp_analyzer")
    ...
    info_html_content = Text(search_analyzer="jp_analyzer")
    business_html_content = Text(search_analyzer="jp_analyzer")
    landing_html_content = Text(search_analyzer="jp_analyzer")

    revenue_predict = Long()
