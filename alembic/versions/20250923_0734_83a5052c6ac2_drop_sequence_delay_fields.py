# flake8: noqa
"""drop sequence delay fields

Revision ID: 83a5052c6ac2
Revises: 753fa9516948
Create Date: 2025-09-23 07:34:11.709461
...
revision = "83a5052c6ac2"
down_revision = "21c64c88e5e5"
branch_labels = None
depends_on = None
        ...
        UNION
            ...
            (SELECT sm.user_id,
                    ...
                    row_number() OVER (PARTITION BY sm.user_id
                                       ORDER BY sm.deleted_at NULLS FIRST, sm.id) AS row_num
                ...
                (
                    SELECT
                        ...
                        row_number() OVER (
                            ...
                            ORDER BY la.deleted_at NULLS FIRST, la.id
                        ) AS row_num
                    FROM
