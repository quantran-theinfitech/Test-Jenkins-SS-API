# flake8: noqa: E501
"""update seuqence_mail_histories with account_option

Revision ID: ea224c339cec
Revises: 285f578e08fc
Create Date: 2025-08-19 04:32:21.088132
...
revision = "ea224c339cec"
down_revision = "285f578e08fc"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.execute("CREATE TYPE accountoption AS ENUM ('DEFAULT', 'MANUAL')")
    op.add_column(
        "sequence_mail_histories",
        sa.Column(
            "account_option",
            sa.Enum("DEFAULT", "MANUAL", name="accountoption"),
            nullable=True,
    ...
    CREATE OR REPLACE VIEW {MAIL_HISTORY_VIEW_NAME} AS (
        ...
        UNION
            ...
            SELECT
                ...
                smh.account_option AS account_option,
                NULL AS email_from,
                smt.title,
                smt.content,
            ...
            (
                SELECT
                    ...
                    la.id) AS row_num
                FROM
                    linkedin_accounts la WHERE la.deleted_at IS NULL) tmp ON
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute(f"DROP VIEW IF EXISTS {MAIL_HISTORY_VIEW_NAME};")
    op.drop_column("sequence_mail_histories", "account_option")
    op.execute("DROP TYPE IF EXISTS accountoption")
    op.execute(
        f"""
    CREATE OR REPLACE VIEW {MAIL_HISTORY_VIEW_NAME} AS (
        SELECT smh.id AS mail_history_id,
